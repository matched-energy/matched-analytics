...
CONSUMPTION_BY_HOUR = DIR_PROCESSED / "watts_up_cp22_feb_1_consumption_by_hour.csv"  # This contains dummy data for now
SUPPLY_BY_HOUR = DIR_PROCESSED / "watts_up_cp22_feb_1_supply_by_hour.csv"
